...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.full_attention.eval_query_chunk_size = max(0, int(getattr(configs, 'isca_eval_query_chunk_size', 256)))
        self.full_attention.sparse_topk_key_chunk_size = max(1, int(getattr(configs, 'isca_sparse_topk_key_chunk_size', 256)))
