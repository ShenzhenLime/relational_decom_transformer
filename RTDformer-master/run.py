...
model_group.add_argument('--dropout', type=float, default=0.4, help='dropout ratio')
...
optimization_group.add_argument('--batch_size', type=int, default=40, help='training batch size')
optimization_group.add_argument('--patience', type=int, default=15, help='early stopping patience')
optimization_group.add_argument('--learning_rate', type=float, default=0.0005, help='optimizer learning rate')
optimization_group.add_argument('--alpha', type=float, default=0.9, help='learning rate decay factor for LambdaLR')
optimization_group.add_argument('--weight_decay', type=float, default=5e-4, help='AdamW weight decay (L2 regularization)')
optimization_group.add_argument('--grad_clip', type=float, default=1.0, help='gradient clipping max norm (0 disables)')
optimization_group.add_argument('--label_smoothing', type=float, default=0.1, help='label smoothing epsilon for NLLLoss (0 disables)')
