...
add_bool_arg(general_group, '--do_predict', False, 'generate future prediction outputs after evaluation')
...
data_group.add_argument('--seq_len', type=int, default=96, help='input sequence length')
data_group.add_argument('--label_len', type=int, default=48, help='decoder warmup length')
data_group.add_argument('--pred_len', type=int, default=48, help='prediction horizon')
data_group.add_argument('--dynamic_stock_cap', type=int, default=None, help='cap stocks per dynamic window')
...
model_group.add_argument('--d_model', type=int, default=512, help='hidden dimension')
model_group.add_argument('--n_heads', type=int, default=8, help='attention heads')
model_group.add_argument('--e_layers', type=int, default=2, help='encoder layers')
...
optimization_group.add_argument('--batch_size', type=int, default=32, help='training batch size')
...
xpu_group.add_argument('--xpu_debug_max_batches', type=int, default=2, help='max batches per loop on XPU debug mode')
xpu_group.add_argument('--xpu_debug_batch_size', type=int, default=1, help='batch size for XPU debug mode')
...
xpu_group.add_argument('--xpu_debug_n_heads', type=int, default=4, help='attention heads for XPU debug mode')
xpu_group.add_argument('--xpu_debug_e_layers', type=int, default=1, help='encoder layers for XPU debug mode')
xpu_group.add_argument('--xpu_debug_stock_cap', type=int, default=500, help='stock cap for XPU debug mode')
